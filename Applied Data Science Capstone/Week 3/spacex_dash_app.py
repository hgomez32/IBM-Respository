...
def get_payload_scatter_chart(entered_site, slider_range):
    ...
    if entered_site == 'ALL':
        ...
        color = 'Booster Version Category', title ='Correlation bewteen Success and Payload between all Sites')
        return fig
    else:
        filtered_df=filtered_df[filtered_df['Launch Site']== entered_site]
        fig=px.scatter(filtered_df,x='Payload Mass (kg)', y ='class',title=f"Correlation between Success and Payload for {entered_site}")
        return fig
